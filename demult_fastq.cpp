...
int main (int argc, char* argv[])
{
  ...
  string R1_file=path_to_reads+"_1.fq.gz";
  string R2_file=path_to_reads+"_4.fq.gz";
  string I1_file=path_to_reads+"_2.fq.gz";
  string I2_file=path_to_reads+"_3_Dseg_append.fq.gz";
